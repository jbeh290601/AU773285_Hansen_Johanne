---
title: "Kongerækken W10"
author: "Johanne Elkær"
date: "05-03-2025"
...
kings1 <- read.csv("data/Kongerækken csv-kopi.csv")
head(kings1)
glimpse(kings1)
class(kings1)


kings2 <- read_csv("data/Kongerækken csv-kopi.csv")
glimpse(kings2)
class(kings2)

kings3 <- read.csv2("data/Kongerækken csv-kopi.csv")
glimpse(kings3)
head(kings3)
class(kings3)

kings4 <- read_csv2( "data/Kongerækken csv-kopi.csv")
glimpse(kings4)
head(kings4)
class(kings4)
```
...
kings <- read.csv2("data/Kongerækken csv-kopi.csv")
